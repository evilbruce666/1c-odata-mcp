...
54 инструмента (21 чтение/аналитика + 33 записи). У всех есть необязательный параметр **`database`** (какая база 1С — см. `list_databases`); у аналитических — ещё и **`organization`** (фильтр по юрлицу — см. `list_organizations`).
